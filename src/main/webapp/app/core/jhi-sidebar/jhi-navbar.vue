            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/vehicle">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.vehicle')">Vehicle</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/vehicle-type">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.vehicleType')">VehicleType</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/vehicle-color">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.vehicleColor')">VehicleColor</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/vehicle-brand">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.vehicleBrand')">VehicleBrand</span>
                    </b-dropdown-item>
